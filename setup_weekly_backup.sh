#!/bin/bash
#
# Setup script for WEEKLY database backups
# Creates backups every Sunday at 2:00 AM and on the 1st of each month
#
...
echo "========================================"
echo "Cruise_Logs Weekly Backup Setup"
echo "========================================"
echo ""
...
if [ "$OS" == "Darwin" ]; then
    ...
    # Create launchd plist file for WEEKLY backups (Sundays)
...
EOF
    ...
    echo "  - 1st of each month at 2:00 AM"
    echo ""
    ...
    echo ""
    echo "To uninstall:"
    echo "  crontab -e  # then remove the backup_database.py lines"
...
echo "  - Weekly backups: backups/weekly/ (12 weeks)"
echo "  - Monthly backups: backups/monthly/ (12 months)"
echo ""
echo "Logs will be written to: ${SCRIPT_DIR}/backup.log"
echo ""
echo "Expected storage usage:"
echo "  - 12 weekly backups: ~360 MB"
echo "  - 12 monthly backups: ~360 MB"
echo "  - Total: ~720 MB"
echo ""
